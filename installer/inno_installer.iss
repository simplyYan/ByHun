...
#define MyAppName "ByHun"
#define MyAppVersion "1.0"
#define MyAppPublisher "ByHun Project"
#define MyAppURL "https://github.com/simplyYan/ByHun"
#define MyAppExeName "byhub.exe"
#define MyAppAssocName MyAppName + " File"
#define MyAppAssocExt ".byhun"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{58BD0DC7-93C1-4341-920F-20D33764A3AE}
AppName={#MyAppName}
...
LicenseFile=C:\Users\wesle\Documents\MeanByte Gaming\MeanByteHUB\ByHub\LICENSE.txt
; Uncomment the following line to run in non administrative install mode (install for current user only).
;PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=dialog
OutputDir=C:\Users\wesle\Documents\MeanByte Gaming\MeanByteHUB\ByHub\installer
OutputBaseFilename=ByHun_WindowsInstaller
